var ls_greet = "Welcome to LocalSupport <@USER_NAME> :slightly_smiling_face: Get started by <https://github.com/AgileVentures/LocalSupport/blob/develop/docs/installation.md#installation| installing the codebase> and our <#C3QFDHMAM|localsupport-install> channel if you need help for anything."

ls_greet += "\n\n\n see https://github.com/AgileVentures/LocalSupport/blob/develop/CONTRIBUTING.md for how to learning more about how to contribute to the project, but feel free to ask questions here too, flagging me with <@U0292M7AC|tansaku> :-)"
...
wso_greet += "\n\n\n Also, once again.... feel free to ask questions here, flagging me with <@U0292M7AC|tansaku>, but do also see our <https://github.com/AgileVentures/WebsiteOne/blob/develop/CONTRIBUTING.md|contribution guidelines> :-)"
...
rfm_greet += " and our <https://github.com/roschaefer/rundfunk-mitbestimmen|Github repository.>"
...
rfm_greet +="\n\nJoin us in our <https://www.agileventures.org/events/rundfunk-mitbestimmen-meeting|weekly scrums>"
...
wed_greet +="\n\nWe would love to hear from you! :simple_smile:"
wed_greet +="\n\nfeel free to ask questions here, flagging me with <@U0292M7AC|tansaku>"

var bot_greet = "Welcome to Bots <@USER_NAME> :slightly_smiling_face: Get started by <https://github.com/AgileVentures/project_greeter_bot/blob/master/README.md#installation|installing the codebase> and feel free to ask questions here too, flagging me with <@U0292M7AC|tansaku> :-) Bots is a project which greets everyone to not let them feel alone here."
...
metplus_greet += "Take a look at our waffle board to find out what we have open and feel free to ask in the respective channel for help finding something to work on or if you have any question."
